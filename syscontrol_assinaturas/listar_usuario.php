...
$result_usuario = "SELECT * FROM clientes ORDER BY id DESC LIMIT $inicio, $qnt_result_pg";
		...
		<tbody>
			...
			while($row_usuario = mysqli_fetch_assoc($resultado_usuario)){
				...
				<tr>
					...
					<td><button type="button" class="btn btn-outline-primary view_data" id="<?php echo $row_usuario['id']; ?>">Visualizar</button></td>
				</tr>
				<?php
			}?>
		</tbody>
